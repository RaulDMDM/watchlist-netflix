...
CREATE TABLE `watchlists` (
  `list_name` varchar(225) NOT NULL,
  `user_name_FK` varchar(225) NOT NULL,
  PRIMARY KEY (`list_name`),
  KEY `user_name_FK` (`user_name_FK`),
  CONSTRAINT `watchlists_ibfk_1` FOREIGN KEY (`user_name_FK`) REFERENCES `users` (`user_name`)
