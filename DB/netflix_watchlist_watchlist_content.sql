...
CREATE TABLE `watchlist_content` (
  `list_name_FK` varchar(225) NOT NULL,
  `content_id_FK` int NOT NULL,
  KEY `list_name_FK` (`list_name_FK`),
  KEY `content_id_FK` (`content_id_FK`),
  CONSTRAINT `watchlist_content_ibfk_1` FOREIGN KEY (`list_name_FK`) REFERENCES `watchlists` (`list_name`),
  CONSTRAINT `watchlist_content_ibfk_2` FOREIGN KEY (`content_id_FK`) REFERENCES `content` (`content_id`)
...
-- Dump completed on 2024-01-14 22:52:00
